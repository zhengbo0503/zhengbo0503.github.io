...
In fact, the Jacobi rotation is the same as the [Givens rotation](https://en.wikipedia.org/wiki/Givens_rotation), but we give the credit to the inventor, Carl G. J. Jacobi.
